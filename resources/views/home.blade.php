            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="col-lg-5 offset-lg-1 align-self-center">
                        <div class="p-5">
                            <h1 class="my-4 font-weight-bold">Selamat Datang Di <span class="text-primary">Dapur Mama</span>.
                            </h1>
                            <p class="font-14 text-muted">Aneka Makanan Dan Minuman Dengan Harga Murah Tapi Kualitas Mahal
                            </p>
