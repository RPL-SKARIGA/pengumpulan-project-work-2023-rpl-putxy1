                                ...
                                <ul class="list-inline mb-0 contact-detail float-end">
                                    <li class="list-inline-item">
                                        <div class="ps-3">
                                            ...
                                            <p class="text-muted mb-0">www.Dapur-Mama.com</p>
                                        </div>
                                    </li>
                                    <li class="list-inline-item">
                                        <div class="ps-3">
                                            <i class="mdi mdi-phone"></i>
                                            <p class="text-muted mb-0">+62 851-6276-0620</p>
                                        </div>
                                    </li>
                                    <li class="list-inline-item">
                                        <div class="ps-3">
                                            <i class="mdi mdi-map-marker"></i>
                                            <p class="text-muted mb-0">41123,Malang Indonesia</p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="col-md-3 d-print-flex">
                                <div class="">
                                    <address class="font-13">
                                        ...
                                        Dapur Mama<br>
                                        Jl. Kemari Membawa harapan No.01<br>
                                        Ds.Tulus RT 05 RW 02
                                        Kec. Anuu Kota Itu, Jawa<br>
                                        <abbr title="Phone">No. Telp:</abbr>+62 851-6276-0620
                                    </address>
                                </div>
                            </div>
                            <!--end col-->
